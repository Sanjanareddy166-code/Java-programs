// program that implement basic bank operations

//1.create account 2.deposit 3.withdraw 4.transfer 5.display 6.list allaccounts 7.exit
...
class Account
{
  String acno,cname;
  double bal;
  //better to declare in bank class static String bname="canara bank"
